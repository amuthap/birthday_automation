...
URL = "https://rotasmart.club/greetings/b/"
...
def extract_member_details(div):
    ...
    if img_tag and img_tag.get("src"):
        ...
        if not img_url.startswith("http"):
            img_url = f"https://rotasmart.club{img_url}" if img_url.startswith("/") else f"https://rotasmart.club/greetings/b/{img_url}"
    # Add current date
...
member_divs = soup.find_all("div", class_="member")
